...
\begin{tabular}{lll}
$(i - 0.6)$ & $(\alpha \rightarrow \delta_j) \rightarrow ((\alpha \rightarrow (\delta_j \rightarrow \delta_i)) \rightarrow (\alpha \rightarrow \delta_i))$ & Сх. акс. 2\\
$(i - 0.4)$ & $((\alpha \rightarrow (\delta_j \rightarrow \delta_i)) \rightarrow (\alpha \rightarrow \delta_i))$ & M.P. из $j$ и $i-0.6$\\
$(i - 0.2)$ & $\alpha \rightarrow \delta_i$ & M.P. из $k$ и $i-0.4$\\
\end{tabular}
