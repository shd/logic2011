...
Тогда мы будем говорить, что высказываение $\alpha$ \emph{выводимо} из $\Gamma$ 
...
Тогда $\alpha_p [x_1, \dots x_n] = \texttt{И}$ и 
$(\alpha_p \rightarrow \alpha_{k+1}) [x_1, \dots x_n] = \texttt{И}$.
Из таблицы истинности импликации следует, что неизбежно $\alpha_{k+1} [x_1, \dots x_n] = \texttt{И}$.
