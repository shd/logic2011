...
$$\omega_1(x,p) \equiv Free(x,\gq{x}) \with Proof (Sub(x,\gq{x},Num(x)),p)$$
...
Заметим, что в случае $Provable1(a) = \exists x (Proof (a,x) \with \neg Proof (\gq{1=0},x))$
...
%(3..p) & $\exists x \exists y (Proof (\gq{2=0},x) \with Proof(\gq{2=0\rightarrow 1=0},y))$ & Доказуемо\\
%(..) & Конкретное доказательство не привести, но оно существует по свойствам $Proof$ &\\
%(p+1..k) & $ \exists x \exists y (Proof (\gq{2=0},x) \with Proof(\gq{2=0\rightarrow 1=0},y) \rightarrow Proof (\gq{1=0}, x @ y @ \gq{1=0}))$\\
%(k+1..l) & $ \exists x \exists y (Proof (\gq{2=0},x) \with Proof(\gq{2=0\rightarrow 1=0},y) \rightarrow \exists p Proof (\gq{1=0}, p))$\\
